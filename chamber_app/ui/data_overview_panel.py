...
class DataOverviewPanel(ctk.CTkFrame):
    ...
    def _setup_ui(self):
        ...
        # Add quick filter bar at the top
        from .filters import QuickFilterBar
        self.filter_bar = QuickFilterBar(self)
        self.filter_bar.grid(row=0, column=0, columnspan=2, sticky="ew", padx=5, pady=5)
          # Connect filter changes to update function  
        self.filter_bar.on_filter_change = lambda: self._on_filter_change(self.filter_bar.get_quick_filters())
    ...
    def _on_filter_change(self, filters):
        ...
        self.logger.info(f"Filters changed: {filters}")
    ...
    def _create_header(self):
        ...
        header_frame.grid(row=1, column=0, columnspan=2, sticky="ew", padx=5, pady=5)
    ...
    def _create_content_area(self):
        ...
        content_frame.grid(row=2, column=1, sticky="nsew", padx=(0, 5), pady=(0, 5))
    ...
    def _create_statistics_sidebar(self):
        ...
        stats_frame.grid(row=2, column=0, sticky="nsew", padx=(5, 0), pady=(0, 5))
    ...
    def _on_status_graph_click(self, event):
        ...
        if event.dblclick:
            # Get clicked bar and show chambers with that status            if hasattr(self, 'status_bars') and event.inaxes == self.status_ax:
