...
from ..utils.threading_utils import start_task_manager, stop_task_manager
from ..utils.performance_monitor import start_performance_monitoring, stop_performance_monitoring
...
class ChamberApplication:
    ...
    def initialize(self):
        ...
        try:
            ...
            if not self.chambers:                self._create_default_chambers()
    ...
    def run(self):
        ...
        try:
            ...
            # Start threading and performance monitoring systems
            start_task_manager()
    ...
    def shutdown(self):
        ...
        # Stop threading and performance monitoring systems
            ...
            if chamber.is_connected:
                try:
                    ...
                    if metrics:
                        ...
                        # Check notification rules with telemetry data
                        if self.notification_manager:
                            telemetry_data = {
                                ...
                                'vacuum_level': metrics.vacuum_level,
                                'status': chamber.state_manager.current_status.value if chamber.state_manager.current_status else 'normal',
                                'timestamp': metrics.timestamp.isoformat() if metrics.timestamp else None
                            }
                            self.notification_manager.check_rules(telemetry_data)
