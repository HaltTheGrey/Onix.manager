    ...
    def export_configuration(self, output_path: Optional[str] = None) -> str:
        ...
        try:
            ...
            for chamber in self.app.get_all_chambers():
              ...
              # Get work requests from all chambers
            try:
                chambers = self.app.get_chambers()
                for chamber in chambers:
                    for wr in chamber.work_requests.values():
                ...
                self.logger.error(f"Error exporting work requests: {e}")
                # Continue export without work requests
